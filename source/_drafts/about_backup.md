...
眼前的这个不起眼的站点大致始于 2019 年年末到 2020 年年初。历经了很多次改版。原定的是一个基于 WordPress 的软件资源站或者开源镜像站。目前最早的文章只能追溯到 **2020-05-07** 最开始使用 Gridea 进行写作，一段时间后开始使用 Hexo + `hexo-theme-icarus` 进行写作并沿用至今。博客最早使用 GitHub Pages 和 Gitee Pages，目前博客部署工作交给 Vercel。Gitee Pages 已废弃，GitHub Pages 用作其他项目。
